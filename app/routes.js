...
// Sign in
router.post('/v21/sign-in', function (req, res) {

  var email = req.session.data['email']
  var password = req.session.data['password']

  if (email && password) {
    res.redirect('/v21/manage-claim-search')
  }
  else {
    res.redirect('/v21/sign-in')
  }
})

// Search
router.post('/v21/manage-claim-search', function (req, res) {

  var searchfirstname = req.session.data['searchfirstname'].toUpperCase().trimEnd()
  var searchlastname = req.session.data['searchlastname'].toUpperCase().trimEnd()

  if (searchfirstname == 'ANITA' && searchlastname == 'BILAL') {
    res.redirect('/v21/manage-claim-search-ANITA-BILAL') // PENDING
  } else if (searchfirstname == 'SARAH' && searchlastname == 'GREEN') {
    res.redirect('/v21/manage-claim-search-SARAH-GREEN') // ACTIVE
  } else if (searchfirstname == 'SIMON' && searchlastname == 'WOODS') {
    res.redirect('/v21/manage-claim-search-SIMON-WOODS') // PENDING EXPIRY
  } else if (searchfirstname == 'JOHN' && searchlastname == 'SMITH') {
    res.redirect('/v21/manage-claim-search-JOHN-SMITH') // EXPIRED
  } else {
    res.redirect('/v21/manage-claim-search-no-results')
  }
})


// Search > Add
router.post('/v21/manage-claim-search-no-results', function (req, res) {

  var searchadd = req.session.data['addperson']

  if (searchadd == 'yes') {
    res.redirect('/v21/create-claim-personal-details')
  } else if (searchadd == 'no') {
    res.redirect('/v21/manage-claim-search')
  }
  else {
...
router.post('/v21/search-add', function (req, res) {

  var searchadd = req.session.data['searchadd']

  if (searchadd == 'yes') {
    res.redirect('/v21/personal-details')
  } else if (searchadd == 'no') {
    res.redirect('/v21/home')
  }
  else {
    res.redirect('/v21/result-not-found')
  }

})

// Pending claim override.
router.post('/v21/manage-claim-pending-override', function (req, res) {
  ...
  if (pendingOverride === 'yes') {
    res.redirect('/v21/manage-claim-pending-override-warning')
  } else if (pendingOverride === 'no') {
    res.redirect('/v21/manage-claim-pending-claim-details')
  } else {
    res.redirect('/v21/manage-claim-pending-override')
  }

})

// Pending claim override warning.
router.post('/v21/manage-claim-pending-override-warning', function (req, res) {
  ...
  if (pendingOverride === 'yes') {
    res.redirect('/v21/review-and-confirm-override')
  } else if (pendingOverride === 'no') {
    res.redirect('/v21/manage-claim-pending-claim-details')
  } else {
    res.redirect('/v21/manage-claim-pending-override-warning')
...
// Active search
router.post('/v21/manage-claim-search-active', function (req, res) {

  var searchlastname = req.session.data['searchlastnamea']
  var searchpostcode = req.session.data['searchpostcodea']

  if (searchlastname && searchpostcode) {
    res.redirect('/v21/manage-claim-search-results-active')
  }
  else {
    res.redirect('/v21/manage-claim-search-no-results-active')
  }
})

// Do you undersatnd

router.post('/v21/before-you-start-ANITA-BILAL', function (req, res) {

  const DoYouUnderstand = req.session.data['do-you-understand']

  if (DoYouUnderstand == 'yes') {
    res.redirect('/v21/manage-claim-ANITA-BILAL-override');
  } else {
    res.redirect('/v21/before-you-start-ANITA-BILAL');
  }

})

router.post('/v21/before-you-start-SARAH-GREEN', function (req, res) {

  const DoYouUnderstand = req.session.data['do-you-understand']

  if (DoYouUnderstand == 'yes') {
    res.redirect('/v21/manage-claim-SARAH-GREEN-override');
  } else {
    res.redirect('/v21/before-you-start-SARAH-GREEN');
  }

})

router.post('/v21/before-you-start-SIMON-WOODS', function (req, res) {

  const DoYouUnderstand = req.session.data['do-you-understand']

  if (DoYouUnderstand == 'yes') {
    res.redirect('/v21/manage-claim-SIMON-WOODS-override');
  } else {
    res.redirect('/v21/before-you-start-SIMON-WOODS');
  }
...
// Select claims
router.post('/v21/manage-claim-ANITA-BILAL-override', function (req, res) {

  var typeofbenefit = req.session.data['type-of-benefit']


  if (typeofbenefit === 'universalcredit') {
    res.redirect('/v21/manage-claim-override-length')
  } else if (typeofbenefit === 'incomesupport') {
    res.redirect('/v21/manage-claim-override-length')
  } else if (typeofbenefit === 'pensioncredit') {
    res.redirect('/v21/manage-claim-override-length')
...
router.post('/v21/manage-claim-SARAH-GREEN-override', function (req, res) {
...
router.post('/v21/manage-claim-SIMON-WOODS-override', function (req, res) {
...
router.post('/v21/manage-claim-JOHN-SMITH-override', function (req, res) {
...
// Confirm Override
router.post('/v21/confirm-override', function (req, res) {
...
router.post('/v21/review-and-confirm-override', function (req, res) {

  const DoYouWantToContinue = req.session.data['do-you-want-to-continue']

  if (DoYouWantToContinue == 'yes') {
    res.redirect('/v21/application-successful');
  } else {
    res.redirect('/v21/review-and-confirm-override');
  }
...
//   if (pendingOverride === 'yes') {
//     res.redirect('/v21/screen-1')
//   } else if (pendingOverride === 'no'){
//     res.redirect('/v21/screen-2')
//   } else {
//     res.redirect('/v21/return-to-same-screen')
//   }
